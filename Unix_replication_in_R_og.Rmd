...
library(BiocManager) # if you do not have BiocManager already installed, you may need to install and upload
BiocManager::install("karyoploteR") # data visualization
library(karyoploteR) # data visualization
